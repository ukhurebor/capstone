...
<body>class="customer-account-register page">
<div id="page"> 
</div>
        ...
        <fieldset class="col2-set">
          ...
          <div class="col-1 new-users"><strong>New Customers</strong>
            <div class="content">
              ...
              <a href="signup" class="button create-account">
          ...
          <div class="col-2 registered-users"><strong>Registered Customers</strong>
            ...
            <div class="content">
              <p><span class="text-danger">${error} ${param.error} </span> <br>If you have an account with us, please log in.              
              </p>
              <ul class="form-list">
                <li>
                ...
                <li>
                  ...
                  <br>
                  <input type="password" title="" id="pass" placeholder="password"  class="input-text" name="password">
                </li>
              </ul>
