        ...
        <div class="container">
          <div class="row"> 
            ...
            <div class="col-xs-7 col-sm-6">
              ...
              <div class="welcome-msg hidden-xs"> Welcome to our Store!</div>
            </div>
                  ...
                  <c:choose>
		            <c:when test="${empty loggedInuser}">
		              ...
		              <div class="login"><a href="register"><span class="hidden-xs">Register</span></a></div>
		               <div class="login"><a href="products"><span class="hidden-xs">Products</span></a></div>
		            </c:when>
		            <c:otherwise>
		           ...
		           <%--  <c:if test="${role eq 'ADMIN' || role eq 'DBA'}"> --%>
		              ...
		              <div class="myaccount"><a title="My Account" href="logout"><span class="hidden-xs">Logout ${role}</span></a></div>
		            </c:otherwise>
		            </c:choose>
                    ...
                    <div class="nav-block nav-block-center">
                      <ul class="level0">
                        ...
                        <li class="level1 nav-6-1 parent item"><a href="#/home-appliances.html"><span>Appliances</span></a>
                         ...
                         <li class="mega-menu ${shop}"><a class="level-top" href="shop"><span>Shop</span></a></li>
